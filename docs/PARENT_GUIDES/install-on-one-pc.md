...
- Write down the 12-word recovery code on paper. It resets dashboard access only;
  it does not back up the evidence encryption key.
...
screen. App names and window titles are recorded as context for alerts. Parents
should assume screenshots may contain sensitive on-screen content.
