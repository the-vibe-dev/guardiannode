...
- We OCR screenshots of *monitored apps / the active window only* by default; full-screen capture is an explicit parent opt-in.
...
The full threat model is in [`installer/shared/tamper_resistance.md`](https://github.com/the-vibe-dev/guardiannode/blob/main/installer/shared/tamper_resistance.md).
